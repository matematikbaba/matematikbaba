...
$settings['apass']='32042135';

/* Website title */
$settings['website_title']="Matematikbaba";

/* Website URL */
$settings['website_url']='http://matematikbaba.github.io/matematikbaba';

/* Guestbook title */
$settings['gbook_title']="Matematikbaba Ziyaretçi Defteri";

/* Your e-mail address. */
$settings['admin_email']='matematikbaba@windowslive.com';

/* URL of the gbook.php file. */
$settings['gbook_url']='http://matematikbaba.github.io/matematikbaba/gbook/gbook.php';

/* If you want to use a logical anti-SPAM question type it here */
$settings['spam_question']='Type <b>15 in 3 eksiği kaç eder?</b> below to show you are not a robot:';

/* Correct answer to the anti-SPAM logical question */
$settings['spam_answer']='12';
